            ...
            <div className="pb-50px px-30px rounded-md">
              ...
              <div className="mt-[50px] md:mt-[100px]">
                <button
                  ...
                  className="w-full bg-[#181A1E] p-3 text-[16px] leading-7"
                >
                  Logout
                </button>

                <button className="w-full bg-red-600 mt-4 p-3 text-[16px] leading-7">
                  Delete account
                </button>
              </div>
            </div>

            <div className="md:col-span-2 md:px-[38px]">
              <div>
                <button
